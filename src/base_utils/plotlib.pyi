...
class XYData:
    ...
    def get_y_at_range(self, xmin: float = -np.inf, xmax: float = np.inf) -> npt.NDArray[np.number]: ...
...
def plot_old(data: XYData, figure_option: FigureOption = ..., save_path: Optional[str] = None) -> None: ...
def plot_simple(
    ax: Axes,
    data: XYData,
    plot_option: PlotOption = ...,
