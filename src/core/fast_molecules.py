...
class FastStructWapper[T: mol.IMolecule]():
    ...
    def is_too_close(self, distance: float=0.09953893710503443) -> bool:
        ...
        mol_identity = np.identity(self.n_mols) * 1000 # big number (Covalent bond at 1000 nm is impossible!) 
        ...
        dist = dist + wrap # if the atoms are in the same molecule, the distance is added by 1000.
        '''
